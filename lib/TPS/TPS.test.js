...
import { getDistance, tonicDistance, regionDistance, } from "./TPS.js";
/*
...
for (let i = 0; i < 21; i++) {
    for (let j = 0; j < 21; j++) {
        const distance = tonicDistance(Chord_default.get(chromaToScale[i]), Chord_default.get(chromaToScale[j]));
