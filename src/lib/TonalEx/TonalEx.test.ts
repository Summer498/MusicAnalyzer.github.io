...
console.log(
    progression.getDistanceOfStates(
        progression.debug().dict.getRomanId(Chord_default.get("Am7"), Scale_default.get("C major")),
        progression.debug().dict.getRomanId(Chord_default.get("G7"), Scale_default.get("C major"))
    )
);
